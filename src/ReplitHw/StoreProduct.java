...
Paper Towels 2.0 null false 0
    ...
    StoreProduct(String labelProduct, double priceProduct,String categoryProduct, boolean stockProduct,int hasExpirationProduct ){
        label=labelProduct;
        price=priceProduct;
        category=categoryProduct;
        hasExpiration=hasExpirationProduct;
        stock=stockProduct;
    }

    void printInfo(){
        System.out.println(label+" "+ price+" "+category+" "+stock+" "+hasExpiration);
    }
